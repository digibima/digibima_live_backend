...
<body>
        ...
        <section class="slide" id="findtopplan">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <form action="{{ route('bike.knowbikesteptwo') }}" method="POST" id="knowcarslideTwo"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 ">
                            <a href="{{ route('bike.knowbike', ['id' => 1]) }}"><button class="continue"
                                    style="width: 100px;">Back</button></a>
                            <button id="continue-button" class="continue mt-2" style="width: 125px;"
                                onClick="DontknowBikeStarted(event);">Continue</button>
    ...
    <script>
        ...
        function DontknowBikeStarted(event) {
