...
<body>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mt-4">
                        <form action="{{ route('motor.login') }}" method="POST" id="indexformID" name="indexForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                    <div class="name mb-4">
                                        ...
                                        <input type="text" id="name" name="name"
                                            value="{{ old('name', $name ?? '') }}" placeholder="Enter Full Name">
                                    </div>
                                    @error('name')
                                    ...
                                    <div class="mobile mb-4">
                                        ...
                                        <input type="text" id="mobile" name="mobile" class="mobiletenInput"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                    ...
                                    <div class="pincode mb-2">
                                        ...
                                        <input type="text" id="pincode" name="pincode" class="pincodesixInput"
                                            value="{{ old('pincode') ?? $pincode }}" placeholder="Enter Pincode"
                                            oninput="acpincode(this)">
    ...
    <script>
        ...
        //     if (!otpSent) {
        //         sendOTP(document.getElementById('mobile').value);
        //     }
        // });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const verifyStatus =
                "{{ $otp}}";
            // const verifyStatus = {{ json_encode($otp) }};
        ...
        function handleGetStarted() {
            ...
            if (email === '') {
                errorTitleElement.innerText = `Please enter your Email.`;
        ...
        function checkInput() {
            var cityInput = document.getElementById('pincode');
