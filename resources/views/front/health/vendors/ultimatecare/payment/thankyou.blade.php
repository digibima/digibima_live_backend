            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 text-left">
                                ...
                                <div id="tbl" class="table-responsive table-bordered tbl">
                                    <table id="datasort" width="100%" data-ordering="false">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p>{{ getconstant('CARESUPREME.POLICYNAME') }}</p>
                                                </td>
                                                <td>
                        ...
                        {{-- @if ($status && !empty($policy)) --}}
                        {{-- <button class="getstarted" onclick="downloadPolicyPdf('{{ $policy }}')">Download
                                PDF</button> --}}
                        {{-- @else --}}
                        <button class="getstarted" onclick="gotoDashboard()">Go To Dashboard</button>
                        {{-- @endif --}}
                        {{-- "{{route('thankyou',['policy'=>$policy])}}" --}}
                    </div>
                </div>
            </div>
        </section>
