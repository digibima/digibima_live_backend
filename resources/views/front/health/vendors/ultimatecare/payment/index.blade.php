    ...
    <main id="slider-container">
        <section id="slide3">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                <h1 class="text-dark">Proposal: {{ $data['proposalNumber'] }}</h1>
                    <form action="{{$data['action']}}" id="PAYMENTFORM" name="PAYMENTFORM" method="POST">
                        @csrf
                        <input type="hidden" name="proposalNum" value="{{$data['proposalNumber']}}">
