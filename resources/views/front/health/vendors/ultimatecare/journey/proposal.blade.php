...
<body class="planlistbg">
    @php
        ...
        $proposar = $data['proposarList'] ?? [];

        $proposardata = $data['proposardata'] ?? [];
        // dd($proposardata);
        $permanentAddress = $proposardata['permanent_address'] ?? [];
        $comunicationAddress = $proposardata['comunication_address'] ?? [];

        $address = is_string($permanentAddress) ? json_decode($permanentAddress, true) : $permanentAddress;

        $comuniaddress = is_string($comunicationAddress)
            ? json_decode($comunicationAddress, true)
            : $comunicationAddress;

        // dd($proposardata,$data);

        $contactRaw = $proposardata['contact_details'] ?? [];
        $contact = is_string($contactRaw) ? json_decode($contactRaw, true) : $contactRaw;

        $detailsRaw = $proposardata['proposer_details'] ?? [];
        $proposerdetails = is_string($detailsRaw) ? json_decode($detailsRaw, true) : $detailsRaw;
        $selfselectedOccupation = $proposerdetails['occupation'] ?? '';

        // dd($proposerdetails);
        $user = HealthJourney::where('userid', Auth::id())->first();
        $addon = $user && $user->addon ? json_decode($user->addon, true) : [];

        $bankdetails = $proposardata['bank_details'] ?? [];
        $bankdetails = is_string($bankdetails) ? json_decode($bankdetails, true) : $bankdetails;
    ...
    <section id="planrow">
        <div class="container-fluid">
            <div class="row filblock">
                ...
                <!-- Left Col Start -->
                <div class="col-md-12 col-lg-12 p-0 mb-2">
                    <a href="{{ route('ultimate.addon') }}" id="backPage" class="smlink" style="display: block"
                        ;><span><i class="bi bi-arrow-left"></i></span> Go back to Previous</a>
                                            ...
                                            <div class="step step-1 active">
                                                <form id="formStepOne">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-12 col-lg-12 col-sm-12 mb-1">
                                                            <label for="field1" class="form-label"> Select
                                                                Proposer</label>
                                                            {{-- complsary verifiy msg input  --}}
                                                            <input type="hidden" id="isPanVerified" value="0" />
                                                            <input type="hidden" id="isAadhaarVerified"
                                                                value="0" />
                                                            <input type="hidden" id="isOtherVerified" value="0" />
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="input-container mb-2">
                                                                <select id="proposar" name="proposar"
                                                                    ...
                                                                    @endif
                                                                    @if (isset($proposar) && is_array($proposar))
                                                                        @foreach ($proposar as $proposarItem)
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 mb-3">
                                                                    <div class="input-container ">
                                                                        @if (isset($proposardata) && is_array($proposardata))
                                                                            <select id="mr_ms_gender"
                                                                                name="mr_ms_gender"
                                                                                class="input form-control"
                                                                                ...
                                                                                <option id="MR" value="Mr"
                                                                                    @selected(($proposardata['gender'] ?? '') === 'Mr')>Mr
                                                                                </option>
                                                                                <option id="MS" value="Ms"
                                                                                    @selected(($proposardata['gender'] ?? '') === 'Ms')>Ms
                                                                                </option>
                                                                            </select>
                                                                        @endif
                                                            ...
                                                            <div class="input-container mb-2">
                                                                <div class="input-group1 datepickerdiv">
                                                                    ...
                                                                    <input type="text" name="proposerdob1"
                                                                        ...
                                                                        class="input form-control datepicker"
                                                                        id="proposerdob1" autocomplete="off"
                                                                        spellcheck="false" maxlength="10"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="house"
                                                                    value="{{ !empty($address) ? $address['address1'] : '' }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="colony"
                                                                    value="{{ !empty($address) ? $address['address2'] : '' }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="Landmark"
                                                                    value="{{ !empty($address) ? $address['landmark'] : '' }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="City"
                                                                    value="{{ strtoupper(!empty($address) ? $address['city'] : '') }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="State"
                                                                    value="{{ strtoupper(!empty($address) ? $address['state'] : '') }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="Pincode"
                                                                    value="{{ strtoupper(!empty($address) ? $address['pincode'] : '') }}"
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <input type="checkbox" class="p-0" value="0"
                                                                    ...
                                                                    {{ !empty($comuniaddress) && ($comuniaddress['sameAddress'] ?? '') == '1' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="row" id="sameAddsection"
                                                        style="{{ !empty($comuniaddress) && ($comuniaddress['sameAddress'] ?? '') == '1' ? 'display:none' : '' }}">
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="commcurrenthouse"
                                                                    value="{{ strtoupper(!empty($comuniaddress) ? $comuniaddress['commcurrenthouse'] : '') }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="commcurrentcolony"
                                                                    value="{{ strtoupper(!empty($comuniaddress) ? $comuniaddress['commcurrentcolony'] : '') }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="commcurrentlandmark"
                                                                    value="{{ strtoupper(!empty($comuniaddress) ? $comuniaddress['commcurrentlandmark'] : '') }}"
                                                                    class="input form-control"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="commcurrentcity"
                                                                    value="{{ strtoupper(!empty($comuniaddress) ? $comuniaddress['commcurrentcity'] : '') }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="commcurrentstate"
                                                                    value="{{ strtoupper(!empty($comuniaddress) ? $comuniaddress['commcurrentstate'] : '') }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="commcurrentpincode"
                                                                    value="{{ strtoupper(!empty($comuniaddress) ? $comuniaddress['commcurrentpincode'] : '') }}"
                                                                ...
                                                                <div class="col-lg-12 d-flex">
                                                                    <div class="input-container "
                                                                        ...
                                                                        <input type="email" name="contactemail"
                                                                            class="input form-control"
                                                                            value="{{ !empty($contact) ? $contact['contactemail'] : '' }}"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                {{-- <input type="text" name="contactmobile"
                                                                    ...
                                                                    value="{{ !empty($contact) ? 'XXXXXX' . substr($contact['contactmobile'], 6, 4) : '' }}"
                                                                    autocomplete="off" spellcheck="false"
                                                                    maxlength="10"
                                                                ...
                                                                <input type="text" name="contactmobile"
                                                                    class="input form-control" id="contactmobile"
                                                                    value="{{ !empty($contact) ? $contact['contactmobile'] : '' }}"
                                                                    autocomplete="off" spellcheck="false"
                                                                    maxlength="10"
                                                                    oninput="handleSubmit('contactemobileError',this,10)"
                                                                    title="Please enter a mobile number (digits only)">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="contactemergency"
                                                                    value="{{ !empty($contact) ? $contact['contactemergency'] : '' }}"
                                                            ...
                                                            <div class="input-container mb-2">
                                                                <div class="input-group1 datepickerdiv">
                                                                    <input type="text" name="proposerdob2"
                                                                        class="input form-control datepicker"
                                                                        id="proposerdob2" autocomplete="off"
                                                                ...
                                                                <select name="proposeroccupation"
                                                                    ...
                                                                    @foreach (['Salaried', 'Self Employed', 'Student', 'Retired'] as $occupation)
                                                                        <option value="{{ $occupation }}"
                                                                            {{ $occupation === $selfselectedOccupation ? 'selected' : '' }}>
                                                                            {{ $occupation }}
                                                                        </option>
                                                                    @endforeach
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-6 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="proposerheight"
                                                                    ...
                                                                    value="{{ !empty($proposerdetails) ? $proposerdetails['height'] : '' }}"
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-6 mb-3">
                                                            <div class="input-container mb-2">
                                                                <input type="text" name="proposerinches"
                                                                    ...
                                                                    value="{{ !empty($proposerdetails) ? $proposerdetails['inch'] : '' }}"
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                                    <div class="input-container mb-2">
                                                                        <select name="spouseoccupation"
                                                                            ...
                                                                            @endforeach
                                                                            @if (isset($proposardata['gender']) && $proposardata['gender'] == 'male')
                                                                                <option value="House wife"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <div class="input-container mb-2">
                                                                <select name="nomineerelation" id="nomineerelation"
                                                                    ...
                                                                    <option value="">Select</option>
                                                                    <option value="Spouse"
                                                                        {{ str_contains($selectedRelation, 'spouse') ? 'selected' : '' }}>
                                                                        Spouse</option>
                                                                    <option value="Father"
                                                                        {{ str_contains($selectedRelation, 'father') ? 'selected' : '' }}>
                                                                        Father</option>
                                                                    <option value="Mother"
                                                                        {{ str_contains($selectedRelation, 'mother') ? 'selected' : '' }}>
                                                                        Mother</option>
                                                                    <option value="Brother"
                                                                        {{ str_contains($selectedRelation, 'brother') ? 'selected' : '' }}>
                                                                        Brother</option>
                                                                    <option value="Sister"
                                                                        {{ str_contains($selectedRelation, 'sister') ? 'selected' : '' }}>
                                                                        Sister</option>
                                                                    <option value="Son"
                                                                        {{ str_contains($selectedRelation, 'son') ? 'selected' : '' }}>
                                                                        Son</option>
                                                                    <option value="Daughter"
                                                                        {{ str_contains($selectedRelation, 'daughter') ? 'selected' : '' }}>
                                                                        Daughter</option>
                                                                </select>
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-2 text-center">
                                    <button class="btnsm" id="cancelpremium"
    ...
    <script>
        ...
        $(".next-step").click(function(event) {
            ...
            if (validateAllFields()) {
                $("#loader").show();
                saveFormStepOne("formStepOne", "{{ route('ultimate.proposalStepOne') }}").then(function( //kavita
                    response) {
                    $("#loader").hide();
                    if (validOk) {
        ...
        function validateAllFields() {
            ...
            if (currentStep === 1) {
                ...
                console.log("validate Form Step One")
        ...
        function validateFormStepOne() {
            ...
            const isPanVerified = document.getElementById('isPanVerified')?.value === "1";
            const isAadhaarVerified = document.getElementById('isAadhaarVerified')?.value === "1";
            const isOtherVerified = document.getElementById('isOtherVerified')?.value === "1";
            ...
            if ((isPanChecked && !isPanVerified) || (isAadhaarChecked && !isAadhaarVerified) || (isOtherChecked && !
                    isOtherVerified)) {
                isValid = false;
                hasError = true;
                displayError("Please complete the card verification first.", null);
                console.log(isPanChecked, !isPanVerified);
                    ...
                    try {
                        ...
                        if (status === "1") {
                            ...
                            $('#verifyPanBtn').html('VERIFIED <i class="fa-solid fa-check ml-2"></i>').prop(
                                'disabled', true);
                            document.getElementById('isPanVerified').value = "1";
        ...
        function verifyAdhar(e) {
            ...
            $.ajax({
                url: "{{ route('ultimate.verifyAdhar') }}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                success: function(response) {
                    ...
                    try {
                        ...
                        if (status === "1") {
                            ...
                            document.getElementById('isAadhaarVerified').value = "1";
        ...
        function getStatusTotalPremium() {
            $.ajax({
                url: "{{ route('ultimate.gettotalpremium') }}",
                type: 'POST',
                data: {
                    _token: "{{ csrf_token() }}"
                },
        ...
        function verifyAlready() {
            ...
            if (kyc == 1) {
                console.log("KYC check in progress...", userData);
                ...
                if (kycDataType == 'p') {
                    ...
                    $("#customerpancardno").val(userData.pan || '');
                    ...
                    // $("#Pincode").val(pincode).prop('readonly', false) || '';
                    ...
                    document.getElementById('isOtherVerified').value = "1";
                    // $('#aadhaarCard').closest('.parent-div').css({
                    //     'pointer-events': 'none',
                    //     'opacity': '0.5'
                    // });
        ...
        async function saveFormStepTwo() {
            ...
            try {
                const response = await $.ajax({
                    url: "{{ route('ultimate.proposalStepTwo') }}",
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
                    ...
                    var smokingStr = members.map((member, mindex) => {
                        ...
                        return `
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-2">
                                ...
                                <div class="input-container1 mb-2 mt-2 ${smokdata}${mindex + 1}" id="${smokcontainerId}" style="display: none;">
                                    <input type="text" 
                                        class="input form-control" 
                                        data-id="${smokIndex + 1}"
                                        data-age="${member.age}" 
                ...
                inputFields.forEach(inputField => {
                    ...
                    if (inputValue.length > 2) {
                        if (dateParts.length === 2) {
                            ...
                            const birthYear = (new Date().getMonth() + 1 >= parseInt(Birthmonth, 10)) ?
                                currentYear - age : currentYear - age - 1;
                            const yearNumber = parseInt(year, 10);

                            // Validate input date range: >= birth date and < current date
                            if (yearNumber < birthYear || (yearNumber === birthYear && month < parseInt(
                                    Birthmonth, 10))) {
                                if (!hasError) {
                                    if (errorTitleElement) {
                                        errorTitleElement.innerText =
                                            `Date should not be before the birth month/year: ${Birthmonth}/${birthYear}.`;
                                        errorBox.style.display = 'flex';
                                        setTimeout(() => {
                                            errorBox.style.display = 'none';
                                        }, 3000);
        ...
        function saveFormStepThree() {
            ...
            $.ajax({
                url: "{{ route('ultimate.proposalStepThree') }}",
                type: 'POST',
            ...
            `;
                    ...
                    insurances.forEach((insure) => {
                        ...
                        var insureHeight =
                            `${insure.height || 'N/A'}' ${insure.inch !== undefined && insure.inch !== null ? insure.inch : 0}"`;
                        var rowHTML = `
        ...
        function goToPayment() {
            ...
            fetch("{{ route('ultimate.createpolicy') }}", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                ...
                .then(data => {
                    console.log(data);
                    const messages = data.error.map(err => err.errDescription);
                    ...
                    if (data.status === '1') {
                        ...
                        window.location.href = "{{ route('ultimate.payment') }}";
                    } else {
                        errorTitleElement.innerText = `${messages}`;
                        errorBox.style.display = 'flex';
                        setTimeout(() => {
                            errorBox.style.display = 'none';
                        }, 5000);
