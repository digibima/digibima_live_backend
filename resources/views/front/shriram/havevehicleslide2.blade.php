...
<body>
        ...
        <section class="slide" id="findtopplan">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <form action="{{ route('commercial.plan') }}" method="POST" id="havevehSlideTwo"
                            name="havevehSlideTwo">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="row" id="dontknowsection">
                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                            <div class="carnumber mb-2">
                                                <label for="havevehnumber">Vehicle Number</label>
                                                <input type="text" id="havevehnumber" name="havevehnumber"
                                                    value="" placeholder="Enter Vehicle Number">
                                            </div>
                                            @error('havevehnumber')
                                                <div class="error" id="havevehnumberError">{{ $message }}</div>
                                            @enderror
                                            <div class="havevehnumb mb-2">
                                                <label for="havevehmodelveh">Model & Variant</label>
                                                <select name="havevehmodelveh" id="havevehmodelveh">
                                            ...
                                            @error('havevehmodelveh')
                                                <div class="error" id="havevehmodelvehError">{{ $message }}</div>
                                            @enderror

                                            <div class="carnumber mb-2">
                                                <label for="havevehbodytype">Type of Body</label>
                                                <input type="text" id="havevehbodytype" name="havevehbodytype"
                                                    value="" placeholder="Enter Type of Body">
                                            </div>
                                            @error('havevehbodytype')
                                                <div class="error" id="havevehbodytypeError">{{ $message }}</div>
                                            @enderror
                                            <div class="havevehnumb">
                                                <label for="havevehregveh">Register Date</label>
                                                <div class="input-group1 datepickerdiv ">
                                                    <input type="text" name="havevehregveh"
                                                        class="input form-control datepicker" id="havevehregveh"
                                            ...
                                            <div class="row">
                                                <div class="havevehnumb mb-2">
                                                    <label for="havevehgvehunder">Select registration under</label>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="myradio radiolabel mb-2">
                                                        <input type="radio" id="individual" name="havevehgvehunder"
                                                ...
                                                <div class="col-lg-6 ">
                                                    <div class="myradio radiolabel mb-2">
                                                        <input type="radio" id="company" name="havevehgvehunder"
                                                            value="company">
                                            ...
                                            <div class="havevehnumb carcompanysection" style="display: none;">
                                                <div class="carnumber mb-2">
                                                    <label for="havevehgstno">GST Number</label>
                                                    <input type="text" id="havevehgstno" name="havevehgstno"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <div class="havevehnumb mb-2">
                                                <label for="havevehmake">Make</label>
                                                <select name="havevehmake" id="">
                                                ...
                                                {{-- <select name="havevehmake" id="havevehmake"
                                                    class="form-control js-example-basic-single" style="width: 100%;">
                                                    <option value="" style="display: none;" selected disabled>
                                                    </option>
                                            ...
                                            <div class=" mb-2">
                                                <div class="carnumber mb-2">
                                                    <label for="havevehcategory">Vehicle Category</label>
                                                    <input type="text" id="havevehcategory" name="havevehcategory"
                                                        value="" placeholder="Enter Company Name">
                                                </div>
                                                @error('havevehcategory')
                                                    <div class="error" id="havevehcategoryError">{{ $message }}
                                                    </div>
                                                @enderror
                                                <div class="carnumber mb-2">
                                                    <label for="havevehcatweight">Gross Vehicle Weight</label>
                                                    <input type="text" id="havevehcatweight"
                                                        name="havevehcatweight" value=""
                                                        placeholder="Enter Company Name">
                                                </div>
                                                @error('havevehcatweight')
                                                    <div class="error" id="havevehcatweightError">{{ $message }}
                                                    </div>
                                                @enderror
                                                <div class="carnumber mb-2">
                                                    <label for="havevehcity">City</label>
                                                    <input type="text" id="havevehcity" name="havevehcity"
                                                        value="" placeholder="Enter Company Name">
                                                </div>
                                                @error('havevehcity')
                                            ...
                                            <div class="havevehnumb carcompanysection" style="display: none;">
                                                <div class="carnumber mb-2">
                                                    <label for="havevehcmpnynme">Company Name</label>
                                                    <input type="text" id="havevehcmpnynme" name="havevehcmpnynme"
                                                        value="" placeholder="Enter Company Name">
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function toggleCarDetails() {
            const Individual = document.querySelector('input[name="havevehgvehunder"][value="individual"]');
            const Company = document.querySelector('input[name="havevehgvehunder"][value="company"]');
        ...
        document.querySelectorAll('input[name="havevehgvehunder"]').forEach(radio => {
        ...
        function HaveVehicleSlideTwo(event) {
            ...
            const havevehnumber = document.getElementById('havevehnumber').value.trim();
            const havevehmake = document.getElementById('havevehmake').value.trim();
            const havevehmodelveh = document.getElementById('havevehmodelveh').value.trim();
            const havevehcategory = document.getElementById('havevehcategory').value.trim();
            const havevehbodytype = document.getElementById('havevehbodytype').value.trim();
            const havevehcatweight = document.getElementById('havevehcatweight').value.trim();
            const havevehcity = document.getElementById('havevehcity').value.trim();
            ...
            const companycheckbox = document.querySelector('input[name="havevehgvehunder"]:checked');
            const havevehcmpnynme = document.getElementById('havevehcmpnynme').value.trim();
            const havevehgstno = document.getElementById('havevehgstno').value.trim();
            ...
            if (companycheckbox?.value === 'company' && !havevehgstno) {
                valid = showError(`GST Number  must be filled.`, '#havevehgstno') && (valid = false);
            }
            if (companycheckbox?.value === 'company' && !havevehcmpnynme) {
                valid = showError(`Company Name must be filled.`, '#havevehcmpnynme') && (valid = false);
            }
            ...
            if (!havevehcity) {
                valid = showError(`Gross Vehicle Weight must be filled.`, '#havevehcity') && (valid = false);
            }
            if (!havevehregveh) {
                valid = showError(`Vehicle Register Date must be selected.`, '#havevehregveh') && (valid = false);
            }

            if (!havevehcatweight) {
                valid = showError(`Gross Vehicle Weight must be filled.`, '#havevehcatweight') && (valid = false);
            }
            if (!havevehbodytype) {
                valid = showError(`Vehicle Type of Body must be filled.`, '#havevehbodytype') && (valid = false);
            }
            if (!havevehcategory) {
                valid = showError(`Vehicle Category must be filled.`, '#havevehcategory') && (valid = false);
            }
            if (!havevehmodelveh) {
                valid = showError(`Vehicle Model & Variant must be selected.`, '#havevehmodelveh') && (valid = false);
            }

            if (!havevehmake) {
                valid = showError(`Vehicle GCCV Make must be selected.`, '#havevehmake') && (valid =
                    false);
            }
            if (!havevehnumber) {
                valid = showError(`Vehicle Number must be filled.`, '#havevehnumber') && (valid = false);
            }
            ...
            if (brands && brands.date) {
                ...
                if (brands.brand && Object.keys(brands.brand).length > 0) {
                    for (let key in brands.brand) {
                        ...
                        $('#havevehmake').append(`<option value="${brandValue}">${brandValue}</option>`);
                    }
                }
                $('#havevehregveh').val(brands.date);

                $('#havevehmake').on('change', function() {
        ...
        async function getModel(selectedBrand) {
            ...
            if (models && Array.isArray(models)) {
                $('#havevehmodelveh').empty();
                $('#havevehmodelveh').append(
                    '<option value="" style="display: none;" selected disabled>Select a brand</option>'
                );
                models.forEach((modelObj) => {
                    const model = modelObj.model;
                    $('#havevehmodelveh').append(`<option value="${model}">${model}</option>`);
                });
            }
        }
        getBrand();
