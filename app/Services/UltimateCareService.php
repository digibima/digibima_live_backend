...
EOD;
    ...
    try {
      ...
      if (
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_URL => 'https://apiuat.careinsurance.com/relinterfacerestful/religare/secure/restful/generatePartnerToken', //k
  ...
  public static function verifyPAN($panid, $dob, $sessionid, $tokenid)
  {
    ...
    try {
      ...
      curl_setopt_array($curl, [
        ...
        //CURLOPT_URL => 'https://apiuat.religarehealthinsurance.com/relinterfacerestful/religare/secure/restful/ckycDownload',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
  ...
  public static function verifyAdhar($adharid, $dob, $name, $gender, $sessionid, $tokenid)
  {
    ...
    try {
      ...
      curl_setopt_array($curl, [
        ...
        //CURLOPT_URL => 'https://apiuat.religarehealthinsurance.com/relinterfacerestful/religare/secure/restful/aadharCKYC',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
  ...
  public static function policyStatus($userId, $sessionid, $tokenid, $proposal)
  {
    ...
    try {
      ...
      curl_setopt_array($curl, [
        //CURLOPT_URL => 'https://apiuat.religarehealthinsurance.com/relinterfacerestful/religare/secure/restful/getPolicyStatusV2',
        CURLOPT_URL => 'https://apiuat.careinsurance.com/relinterfacerestful/religare/secure/restful/getPolicyStatusV2', //k
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    if (isset($filename)) {
      if (file_exists($filePath)) {
        ...
        try {
          ...
          $curl = curl_init();
          curl_setopt_array($curl, [
            //CURLOPT_URL => 'https://apiuat.religarehealthinsurance.com/relinterfacerestful/religare/secure/restful/uploadEkycDocument',
            CURLOPT_URL => 'https://apiuat.careinsurance.com/relinterfacerestful/religare/secure/restful/uploadEkycDocument', //k
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
  ...
  public static function creatpolicyport($userId, $sessionid, $tokenid)
  {
    try {
      ...
      $curl = curl_init();
      curl_setopt_array($curl, [
        CURLOPT_URL => 'https://apiuat.careinsurance.com/relinterfacerestful/religare/secure/restful/createPolicyPortability',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
  ...
  public static function checkPanVerify($userId, $panid, $dob, $mobile, $gender, $name)
  {
    try {
      ...
      $curl = curl_init();
      curl_setopt_array($curl, [
        CURLOPT_URL => 'https://ix-uat.careinsurance.com/connect-service/kyc/v3/otp/generate',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_POST => true,
        CURLOPT_POSTFIELDS => $payload,
  ...
  public static function verifyOtp($userId, $mobile, $otp)
  {
    try {
      ...
      $curl = curl_init();
      curl_setopt_array($curl, [
        CURLOPT_URL => 'https://ix-uat.careinsurance.com/connect-service/kyc/v3/otp/verify',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_POST => true,
        CURLOPT_POSTFIELDS => $payload,
        CURLOPT_HTTPHEADER => $headers,
    ...
    if (isset($filename)) {
      if (file_exists($filePath)) {
        ...
        try {
          ...
          $curl = curl_init();
          curl_setopt_array($curl, [
            CURLOPT_URL => 'https://apiuat.careinsurance.com/relinterfacerestful/religare/secure/restful/uploadPortabilityDocument',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
