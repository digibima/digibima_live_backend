...
use App\Models\Shriram\{Shriram_Pincode, Shriram_planCheckout, Shriram_RTO_Master, Shriram_Vehicle_Master, Shriram_Finance_Master, Shriram_Prev_insurence};
...
class ZunoCarService
{
    ...
    public static function generatePrivateCarQuote(Request $request, $nextyear, $nPlanType)
    {
        try {
            ...
            //$avehicle_details = DataModel::where('userid',$userId)->first();
            //return $avehicle_details; 
            $today = now();
            $oModel = null;
            $claim = null;
            $claimper = null;
            ...
            // return [
            //     "sPrevexptoDate" => $sPrevexptoDate,
            //     "PrevexptoDate" => $PrevexptoDate
            // ];
            ...
            //return $IdvDetails['idvAmount']['upto1Year'];
            // $details = json_decode($IdvDetails);
            // return $details->idvAmount->upto1Year;
            ...
            SetCache($cache_idv, $IdvDetails['idvAmount']['upto1Year']);
                            ...
                            "coverage" => [
                                ...
                                "subCoverage" => [
                                    [
                                        ...
                                        "thirdPartyPropertyDamageLimit" => "0"
                                    ],
                                    [
    ...
    public static function privateCarProposal(Request $request, $today, $nextyear, $aData)
    {
        try {
            ...
            // return [
            //     "sPrePolicyType" => $sPrePolicyType,
            //     "sPrevexptoDate" => $sPrevexptoDate,
            //     "sPrevexpfDate" => $sPrevexpfDate,
            //     "sPretpfDate" => $sPretpfDate,
            //     "sPretptoDate" =>$sPretptoDate,
            //     "nTpolicyNo" => $nTpolicyNo,
            //     "sTpInsurer" =>$sTpInsurer,
            //     "tpInsurCmpny" => $tpInsurCmpny,
            //     "PolicyFromDate" => $PolicyFromDate,
            //     "PolicyToDate" => $PolicyToDate
            ...
            $postdata = json_encode([
                ...
                "previousPolicyStartDate" => $sPrevexpfDate ?? "", //"2025-06-30",
                "previousPolicyEndDate" => $sPrevexptoDate ?? "",//"2023-07-01",
                "previousPolicyNo" => (GetCache($cachemotortype) == "newcar") ? "" : "34245243DFS",//"3425245245243DFS",
                "natureOfLoss" => "NA",
                ...
                "validLicenceNo" => "Y",
                "fuelType" => "HYBRID",
                "newOrUsed" => ($VehicleType == "U") ? "U" : "N",
                "yearOfManufacture" => $sManuYear ?? "",
                "registrationDate" => $sRegdate ?? "",
                "vehicleAge" => "0",// Carbon::parse($sRegdate)->format('Y-m-d')->diffInYears(Carbon::now()) ?? "",
                "engineeNumber" => $EngineNo ?? "were5632345234DFS",
                "chassisNumber" => $ChassisNo ?? "3456356356345DFS",
                "fibreGlassFuelTank" => "N",
                ...
                "requiredDiscountOrLoadingPercentage" => "-75",
                "financeType" => [],
                "financierName" => [],
                ...
                "lastName" => "asdf",
                "gender" => ($oJourneyData->gender == "Mr") ? "M" : "F",
                "policyHolderGender" => ($oJourneyData->gender == "Mr") ? "M" : "F",
                "maritalStatus" => "",
                ...
                "inspectionNumber" => "",
                "ewSource" => "NA",
                "inspectionPurpose" => "NA",
                "approvalDeclineReason" => "NA",
                "approvalDeclineDate" => "",
                "renewalstatus" => "New Policy",
