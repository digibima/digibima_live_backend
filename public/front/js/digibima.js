...
$(document).ready(function () {
  $("#medicalonetoggle").change(function () {
    if ($(this).is(":checked")) {
      $(".medicalonesub").css("display", "table-row-group"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $("#medicalonetoggletwo").change(function () {
    if ($(this).is(":checked")) {
      $(".medicalonesubtwo").css("display", "table-row-group"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $("#lifestyletoggletwo").change(function () {
    if ($(this).is(":checked")) {
      $(".lifestylesub").css("display", "table-row-group"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".Cancer").change(function () {
    if ($(this).is(":checked")) {
      $(".Cancersub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".heart").change(function () {
    if ($(this).is(":checked")) {
      $(".heartsub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".hypertension").change(function () {
    if ($(this).is(":checked")) {
      $(".hypertensionsub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".breathing").change(function () {
    if ($(this).is(":checked")) {
      $(".breathingsub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".endocrine").change(function () {
    if ($(this).is(":checked")) {
      $(".endocrinesub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".diabetes").change(function () {
    if ($(this).is(":checked")) {
      $(".diabetessub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".muscles").change(function () {
    if ($(this).is(":checked")) {
      $(".musclessub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".liver").change(function () {
    if ($(this).is(":checked")) {
      $(".liversub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".kidney").change(function () {
    if ($(this).is(":checked")) {
      $(".kidneysub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".auto").change(function () {
    if ($(this).is(":checked")) {
      $(".autosub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".any").change(function () {
    if ($(this).is(":checked")) {
      $(".anysub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".has").change(function () {
    if ($(this).is(":checked")) {
      $(".hassub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".hasany").change(function () {
    if ($(this).is(":checked")) {
      $(".hasanysub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".insurer").change(function () {
    if ($(this).is(":checked")) {
      $(".insurersub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".premium").change(function () {
    if ($(this).is(":checked")) {
      $(".premiumsub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".insurance").change(function () {
    if ($(this).is(":checked")) {
      $(".insurancesub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".cigarettes").change(function () {
    if ($(this).is(":checked")) {
      $(".cigarettessub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".bidis").change(function () {
    if ($(this).is(":checked")) {
      $(".bidissub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".Pan").change(function () {
    if ($(this).is(":checked")) {
      $(".Pansub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".whisky").change(function () {
    if ($(this).is(":checked")) {
      $(".whiskysub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".wine").change(function () {
    if ($(this).is(":checked")) {
      $(".winesub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".beer").change(function () {
    if ($(this).is(":checked")) {
      $(".beersub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
$(document).ready(function () {
  $(".drugs").change(function () {
    if ($(this).is(":checked")) {
      $(".drugssub").css("display", "block"); // Show the tbody as a table row group
    } else {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  inputs.forEach((input) => {
    const placeholder = input.nextElementSibling; // Assuming placeholder is the next sibling element
...
function registrNumbInput() {
  var regInputs = document.querySelectorAll(".registrnobInput");
  regInputs.forEach(function (input) {
    autoUppercase(input);
    const pattern = /^[A-Z0-9]{0,10}$/;
    let inputValue = input.value;
    if (!pattern.test(inputValue)) {
      input.value = inputValue.replace(/[^A-Z0-9]/g, "").substring(0, 10);
    }
  });
}
...
// Date Format Define globally accessible function
function formatDateInput(event) {
  ...
  if (typeof clearErrorTwo === "function") {
      clearErrorTwo(errorId);
  }
}


function formatDateInputOne(event) {
  let input = event.target;
